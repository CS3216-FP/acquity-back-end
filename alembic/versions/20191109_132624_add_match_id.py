...
from src.database import ChatRoom, Match, BuyOrder, SellOrder
...
def upgrade():
    ...
    for match in matches:
        ...
        chat_room = session.query(ChatRoom).filter_by(
    ...
    op.create_foreign_key(u'chat_room_match_id-match_id', "chat_rooms", "matches", ["match_id"], ["id"])
